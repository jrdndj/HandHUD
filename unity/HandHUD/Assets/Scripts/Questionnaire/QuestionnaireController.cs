...
public class QuestionnaireController : MonoBehaviour
{
    ...
    // custom by Me
    [SerializeField] private GameObject conditionViewGO;

    private SliderView sliderView;
    private ToggleGroupView radioView;
    private ToggleGroupView multipleChoiceView;
    // custom by Me
    private ToggleGroupView conditionView;
    ...
    void Awake()
    {
        ...
        conditionView = conditionViewGO.GetComponent<ToggleGroupView>();
    ...
    private void DeactivateAllViews()
    {
        ...
        conditionViewGO.SetActive(false);
    }
    ...
    private void DisplayCurrentQuestion()
    {
        ...
        else if (qData.type == "condition")
        {
            conditionViewGO.SetActive(true);
            forwardButton.interactable = false;
            questionnaireUIView.UpdateView(model.QuestionnaireName, qData.text, model.currentQuestionIndex, model.GetTotalQuestions());
            conditionView.UpdateConditionView();
        }
        ...
        if (model.sessionResponses.ContainsKey(qData.id))
        {
            ...
            else if (qData.type == "condition") { conditionView.SetScore(savedScore); }
        }
